...
select hd.MaHD,hd.TenHD,hd.NoiDungHD,hd.MaTeam,hd.NgayThucHien,hd.DiaDiem from HoatDong hd where hd.TenHD like N'%sinh%'
select COUNT(*) as dem from ThanhVien tv full outer join PhanCongViec pc on tv.MaSV=pc.MaSV  where tv.MaSV = 'SV001' and pc.MaHD=''
 UPDATE ThanhVien SET GioiTinh =N'Nữ' Where MaSV = 'Sv006'
